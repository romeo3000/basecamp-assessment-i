...
var myName ="Dennis Lee";
Var faveNum = 7;
var me = "My is "+myName+ "and my favorite number is" +faveNum;
...
console.log("You're" +age+ "and legally can drive now with a driver's license!");
};
